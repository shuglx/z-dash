...
const pet = {
  ...
  PETS: {
    'cyberpunk-lucy': {
      ...
      CLICKS: [
        '04-点击回应-从容愉悦', '05-点击回应-别扭害羞', '06-点击回应-义眼警告',
        '07-点击回应-小恶魔调笑', '08-点击回应-摸头反应',
      ],
      DRAG: '24-拖拽·悬空吊起反应',
  ...
  switchTo(next, once) {
    ...
    const onReady = () => {
      ...
      if (pm && this.def.MOVE_INTRINSIC && this.def.MOVE_INTRINSIC[this.anim]) {
        const dir = pm.dir > 0 ? 'right' : 'left';
        flip = this.def.MOVE_INTRINSIC[this.anim] !== dir;
      }
